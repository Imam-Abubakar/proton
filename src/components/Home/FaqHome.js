                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="appie-section-title text-center">
                                ...
                                <p>What you might want to know about us.</p>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <div className="accrodion-inner">
                                            ...
                                            >
                                                <div className="inner">
                                                    <p>
                                                       Proton is an abstract company created as a final year project implementation
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    >
                                        <div className="accrodion-inner">
                                            <div className="accrodion-title">
                                                <h4>What can I use Proton for?</h4>
                                            </div>
                                            <div
                                                className="accrodion-content"
                                                style={{
                                            ...
                                            >
                                                <div className="inner">
                                                    <p>
                                                        You can use it to verify almost any product using its barcode. We have a large database that supports this.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <div className="accrodion-inner">
                                            <div className="accrodion-title">
                                                <h4>What kinds of product can I verify?</h4>
                                            </div>
                                            <div
                                                className="accrodion-content"
                                                style={{
                                            ...
                                            >
                                                <div className="inner">
                                                    <p>
                                                       Anything that is on sale, ranging from drugs to groceries to novels and games. You can verify it all.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    >
                                        <div className="accrodion-inner">
                                            <div className="accrodion-title">
                                                <h4>What if I can't find a product?</h4>
                                            </div>
                                            <div
                                                className="accrodion-content"
                                                style={{
                                            ...
                                            >
                                                <div className="inner">
                                                    <p>
                                                        Either that product is not authentic or it is not in our database yet.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="col-lg-12">
                            <div className="faq-text text-center pt-40">
                                <p>
                                    ...
                                    <a href="mailto:visualsfred@gmail.com">Email us</a>
                                </p>
                            </div>
                        </div>
                    </div>
